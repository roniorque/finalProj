...
<!-- content start-->
  ...
  <main>
    <div class="container">
      ...
      <a href="all_items.php">shop now</a>
    </div>
      ...
      <div class="swiper-wrapper">
        <div class="swiper-slide swiper-slide--one">
          <div>
            ...
            <a href="women_accessories.php">explore</a>
          </div>
        </div>
        <div class="swiper-slide swiper-slide--two">
          <div>
            ...
            <a href="women_top.php" target="_blank">explore</a>
          </div>
        </div>
        ...
        <div class="swiper-slide swiper-slide--three">
          ...
          <div>
            ...
            <a href="women_footwear.php" target="_blank">explore</a>
          </div>
        </div>
        ...
        <div class="swiper-slide swiper-slide--four">
          <div>
            ...
            <a href="women_bottoms.php" target="_blank">explore</a>
          </div>
        </div>
        ...
        <div class="swiper-slide swiper-slide--five">
          ...
          <div>
            ...
            <a href="men_top.php" target="_blank">explore</a>
          </div>
        </div>
  </div>
      <!-- Add Pagination -->
   ...
   <swiper-slide class="image15" >  
    ...
    <swiper-slide class="image17" >
      <a class="image14" href="women_top.php"><button class="btn-4"> SHOP NOW </button></a>
