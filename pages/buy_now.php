                        ...
                        <div class="row bg-light m-0">
                            ...
                            <div class="col-12 px-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="shipping-address" placeholder="Enter shipping address">
                                </div>
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        <label for="shipping-city" class="form-label">City</label>
                                        <input type="text" class="form-control" id="shipping-city" placeholder="Enter city">
                                    </div>
                                    <div class="col-md-4 mb-3">
                                        <label for="shipping-state" class="form-label">State</label>
                                        <input type="text" class="form-control" id="shipping-state" placeholder="Enter state">
                                    </div>
                                    <div class="col-md-2 mb-3">
                                        <label for="shipping-zip" class="form-label">ZIP</label>
                                        <input type="text" class="form-control" id="shipping-zip" placeholder="Enter ZIP code">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-12 px-4">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="billing-zip" placeholder="Enter ZIP code">
                                    </div>
                                </div>
                            </div>
                        </div>
