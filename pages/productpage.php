  ...
  <a href="#" class="shop-item">
        ...
        <a href="#" class="shop-item">
          ...
          <div class="quickview">
            ...
            <span class="quickview__info">Mal De Wear BTS Dynamite Regular Fit Shorts with Raw Edge Hem<br><span class="quickview__info--price" id="BTSRegularFitShortsPrice">₱298.00</span></span>
          </div>
        </a>
        <a href="#" class="shop-item">
